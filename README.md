...
- **[ReceiptRival](https://github.com/cHANGTEEZY/ReceiptRival)** — An Expo + React Native app with a Convex backend to split receipts and track who owes whom in real-time.
- **[Windows 7 Portfolio](https://github.com/cHANGTEEZY/windows)** — A retro web-based Windows 7 clone / portfolio featuring drag-and-drop, Next.js App Router, and Postgres.
- **[The Chang Theory](https://github.com/cHANGTEEZY/The_Chang_Theory)** — A collection of technical articles, deep-dive tutorials, and thoughts on software development and architecture.
...
|-------|------------------------|
| [Dan Abramov](https://overreacted.io) | Dense, honest writing on React internals and how to think about software |
| [Josh Comeau](https://www.joshwcomeau.com) | Excellent interactive explanations of CSS and React |
| [Dominik Dorfmeister](https://tkdodo.eu/blog) | React Query maintainer with practical, zero-fluff insights |
| [Lee Robinson](https://leerob.io) | Next.js, developer experience, and product thinking from inside Vercel |
| [Kent C. Dodds](https://kentcdodds.com/blog) | Testing philosophy, React patterns, and straightforward career writing |
